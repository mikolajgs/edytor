  ...
  connectedCallback() {
    [
      ...
      i.addEventListener('input', (e) => {
        document.getElementById('edytor').selectColour(t.name, e.target.value);
      });
      ...
      document.getElementById('edytor').selectColour(t.name, i.value);
    });
    ...
    btn.addEventListener('click', (e) => {
      ...
      document.getElementById('edytor').selectColour("fg", bgColor);
      document.getElementById('colour_picker_bg').value = fgColor;
      document.getElementById('edytor').selectColour("bg", fgColor);
    });
